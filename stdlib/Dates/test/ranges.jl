...
@test map!(x->x + Dates.Day(1), Vector{Dates.DateTime}(uninit, 32), dr) == [(a + Dates.Day(1)):Dates.Day(1):(b + Dates.Day(1));]
...
@test map!(x->x + Dates.Day(1), Vector{Dates.Date}(uninit, 32), dr) == [(a + Dates.Day(1)):Dates.Day(1):(b + Dates.Day(1));]
@test map(x->x + Dates.Day(1), dr) == [(a + Dates.Day(1)):Dates.Day(1):(b + Dates.Day(1));]

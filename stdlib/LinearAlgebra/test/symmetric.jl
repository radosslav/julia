    ...
    @testset for eltya in (Float32, Float64, ComplexF32, ComplexF64, BigFloat, Int)
        ...
        @testset "linalg binary ops" begin
            ...
            @testset "mat * mat" begin
                ...
                @test_throws DimensionMismatch Hermitian(aherm) * Vector{eltya}(uninit, n+1)
                ...
                @test_throws DimensionMismatch Symmetric(asym) * Vector{eltya}(uninit, n+1)
...
@testset "#25625 recursive transposition" begin
    A = Matrix{Matrix{Int}}(uninit, 2, 2)
    A[1,1] = [1 2; 2 3]
    A[1,2] = [4 5 6; 7 8 9]
    A[2,1] = [4 7; 5 8; 6 9]
    A[2,2] = [1 2; 3 4]
    ...
    B = Matrix{Matrix{Complex{Int}}}(uninit, 2, 2)
    B[1,1] = [1 2+im; 2-im 3]

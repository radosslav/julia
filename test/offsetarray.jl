...
A_3_3 = OffsetArray(Matrix{Int}(uninit, 3,3), (-2,-1))
...
am = OffsetArray{Int}(uninit, (1:1, 7:9))  # for testing linear indexing
fill!(am, -1)
copyto!(am, b)
@test am[1] == 1
@test am[2] == 2
...
dest = OffsetArray(Matrix{Int}(uninit, 4,4), (-1,1))
circcopy!(dest, src)

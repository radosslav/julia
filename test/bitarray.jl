...
@testset "empty bitvector" begin
    @test BitVector() == BitVector(uninit, 0)
end
...
@testset "utility functions" begin
    ...
    @testset "sizeof (issue #7515)" begin
        @test sizeof(BitVector(uninit, 64)) == 8
        @test sizeof(BitVector(uninit, 65)) == 16
    end
end
...
@testset "Constructors" begin
    @testset "non-Int dims constructors" begin
        b1 = BitVector(uninit, Int32(v1))
        b2 = BitVector(uninit, Int64(v1))
    ...
    @testset "one" begin
        @test Array(one(BitMatrix(uninit, 2,2))) == Matrix(I, 2, 2)
        @test_throws DimensionMismatch one(BitMatrix(uninit, 2,3))
    end

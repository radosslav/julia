...
# issue #6719
@test isequal(typeof(map(x -> x, Vector{Union{}}(uninit, 0))), Vector{Union{}})
...
let gens_dims = [((i for i = 1:5),                    1),
                 ...
                 ((i for i = Array{Int,0}(uninit)),           0),
                 ((i for i = Vector{Int}(uninit, 1)),          1),
                 ((i for i = Matrix{Int}(uninit, 1, 2)),       2),
                 ((i for i = Array{Int}(uninit, 1, 2, 3)),    3)]
